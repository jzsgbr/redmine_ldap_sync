...
# encoding: utf-8
# Explicit betöltés: az entity_manager szükséges az LdapTest osztályhoz.
# A vendor/ldap_sync_lib/ a $LOAD_PATH-ban van (init.rb állítja be).
...
module LdapSync
  module EntityManager; end
end unless defined?(LdapSync::EntityManager)
