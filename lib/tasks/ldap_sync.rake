...
namespace :redmine do
  namespace :plugins do
    namespace :ldap_sync do
      ...
      def ensure_infectors_loaded
        # to_prepare nem fut rake task-nál, ezért itt töltjük be az infectorokat
        vendor_lib = File.expand_path('../../vendor/ldap_sync_lib', File.dirname(__FILE__))
